...
document.getElementById('app9').innerHTML = `
    <div class="archive-catagory-view mb-50 d-flex align-items-center justify-content-between">
        <div class="archive-catagory">
            <h4><i class="fa fa-book" aria-hidden="true"></i> Reviews </h4>
        </div>
        <div class="view-options">
            <a href="review-grid.html"><i class="fa fa-th-large" aria-hidden="true"></i></a>
            <a href="review-list.html" class="active"><i class="fa fa-list-ul" aria-hidden="true"></i></a>
        </div>
    </div>
  ${reviewVideoData.map(HowTotemplateList).join('')}
`;
